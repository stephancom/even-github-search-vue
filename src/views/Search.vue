...
export default {
  ...
  methods: {
    ...
    urlParams() {
      var params = {};
      if (this.paramOK("topic")) {
        params["topic"] = this.form.topic;
      }
      if (this.paramOK("stars")) {
        params["stars"] = this.form.stars;
      }
      if (this.paramOK("license")) {
        params["license"] = this.form.license;
      }
      if (this.paramOK("fork")) {
        params["fork"] = true;
      }
      return params;
    },
    queryParams() {
      var q = [];
      if (this.paramOK("topic")) {
        q.push(this.paramEncode("topic"));
      }
      if (this.paramOK("stars")) {
        q.push("stars:" + this.paramEncode("stars"));
      }
      if (this.paramOK("license")) {
        q.push("license:" + this.paramEncode("license"));
      }
      if (this.paramOK("fork")) {
        q.push("fork:true");
      }
